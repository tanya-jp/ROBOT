...
(cl:defmethod cl:initialize-instance :after ((m <dist>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'dist)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name sen_one-msg:<dist> is deprecated: use sen_one-msg:dist instead.")))

(cl:ensure-generic-function 'obstacle_name-val :lambda-list '(m))
(cl:defmethod obstacle_name-val ((m <dist>))
...
(cl:defmethod distance-val ((m <dist>))
